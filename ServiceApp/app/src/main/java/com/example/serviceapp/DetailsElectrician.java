                ...
                if(bedno.isEmpty()) {
                    ...
                    ValueRange body = new ValueRange()
                            .setValues(Arrays.asList(
                                    Arrays.asList(sp.getString("Email",null),problem.getText().toString(),roomno.getText().toString(),bed.getText().toString(),"Electrician")
                            ));
                    ...
                    ValueRange body2 = new ValueRange()
                            .setValues(Arrays.asList(
                                    Arrays.asList(sp.getString("Email",null),"Electrician Service",currentDate.toString(),"Pending")
                            ));
