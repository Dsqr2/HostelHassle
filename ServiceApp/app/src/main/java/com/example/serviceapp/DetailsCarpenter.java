    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DetailsCarpenter.this, Dashboard.class);
                ...
                if(bedno.isEmpty()) {
                    ...
                    ValueRange body = new ValueRange()
                            .setValues(Arrays.asList(
                                    Arrays.asList(sp.getString("Email",null),problem.getText().toString(),roomno.getText().toString(),bed.getText().toString(),"Carpenter")
                            ));
                    ...
                    ValueRange body2 = new ValueRange()
                            .setValues(Arrays.asList(
                                    Arrays.asList(sp.getString("Email",null),"Carpenter Service",currentDate.toString(),"Pending")
                            ));
