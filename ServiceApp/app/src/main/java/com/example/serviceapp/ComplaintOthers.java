...
public class ComplaintOthers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complaintothers);
        ...
        t.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =new Intent(ComplaintOthers.this,History.class);
                startActivity(intent);
            }
        });
                ...
                if(prblm.isEmpty()) {
                    ...
                    ValueRange body = new ValueRange()
                            .setValues(Arrays.asList(
                                    Arrays.asList(sp.getString("Email",null),problem.getText().toString(),roomno.getText().toString(),"","Others Complaint")
                            ));
                    appendDataToSheet(body);
                    Toast.makeText(ComplaintOthers.this, "Service Registered", Toast.LENGTH_SHORT).show();
                    roomno.setText("");
                    problem.setText("");
                    ...
                    ValueRange body2 = new ValueRange()
                            .setValues(Arrays.asList(
                                    Arrays.asList(sp.getString("Email",null),"Others",currentDate.toString(),"Pending")
                            ));
