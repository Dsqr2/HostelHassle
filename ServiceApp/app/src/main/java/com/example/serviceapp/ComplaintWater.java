...
public class ComplaintWater extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complaintwater);
                ...
                if(prblm.isEmpty()) {
                    ...
                    ValueRange body = new ValueRange()
                            .setValues(Arrays.asList(
                                    Arrays.asList(sp.getString("Email",null),problem.getText().toString(),roomno.getText().toString(),"","Drinking Water Complaint")
                            ));
                    appendDataToSheet(body);
                    Toast.makeText(ComplaintWater.this, "Service Registered", Toast.LENGTH_SHORT).show();
                    roomno.setText("");
                    problem.setText("");
                    ...
                    ValueRange body2 = new ValueRange()
                            .setValues(Arrays.asList(
                                    Arrays.asList(sp.getString("Email",null),"Drinking Water",currentDate.toString(),"Pending")
                            ));
